# Generated by Django 4.1 on 2022-12-13 14:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alimentos', models.ManyToManyField(related_name='alimentos', to='core.alimento')),
                ('cardapios', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.cardapio')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
